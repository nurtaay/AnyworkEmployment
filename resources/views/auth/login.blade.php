...
<div class="container" style="margin-top: 70px">
    <div class="row py-5 mt-4 align-items-center">
        ...
        <!-- Registeration Form -->
        <div class="col-md-7 col-lg-6 ml-auto" style="margin-left: 100px">
            <form action="{{route('login')}}" method="post">
                ...
                <div class="row">
                    ...
                    <div class="text-center w-100">
                        <p class="text-muted font-weight-bold">Already Registered? <a href="{{route('register.form')}}" class="text-primary ml-2">Registration</a></p>
                    </div>
